import { HiCurrencyDollar, HiDevicePhoneMobile, HiRectangleGroup } from "react-icons/hi2";
    ...
    >
      <div className=" flex flex-col  gap-y-4 justify-between">
        <div className="flex items-center gap-x-4">
          ...
          <h1 className="font-semibold ">متین</h1>
        </div>
        ...
        <div className="flex w-full items-center  px-2 justify-between ">
          <div className="flex items-center gap-x-2">
            ...
            <span className="text-xs block">09178694062</span>
          </div>
          <div className="flex items-center justify-center  gap-x-2">
            <span className="block text-xl stroke-2">
              <HiRectangleGroup />
            </span>
            <span className="text-xs block">5645645</span>
          </div>
        </div>
